...
This library provides Cython .pxd files for Google's Sparsehash library. As yet
it's only intended for use directly from Cython. I doubt it'll be of any use
